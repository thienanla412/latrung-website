...
<body>
    ...
    <!-- Manufacturer Showcase (Home) -->
    <section class="home-manufacturer">
        <div class="container">
            <div class="home-manufacturer-content">
                <div class="manufacturer-image-wrapper">
                    <img src="/assets/printing-machine.png" alt="La TRUNG Manufacturing Facility">
                </div>
                <div class="manufacturer-text-wrapper">
                    <h2><?php echo t('about.facility.title'); ?></h2>
                    <p><?php echo t('about.facility.intro'); ?></p>
                    <a href="/about" class="btn btn-secondary"><?php echo t('home.hero.btn_about'); ?></a>
                </div>
            </div>
        </div>
